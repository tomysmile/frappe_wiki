...
| Ubuntu           | 18.04                                | Steve Nyaga [@stevenyaga](https://github.com/stevenyaga) <br/> You can easily set up production by running `bench setup production`. Then you are able to run `bench restart` or `supervisorctl restart/start/stop all` |